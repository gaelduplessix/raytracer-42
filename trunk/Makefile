...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Tue May 3 16:58:08 2011
...
compiler_moc_header_make_all: moc_gui.cpp moc_guisfml.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_gui.cpp moc_guisfml.cpp
...
moc_guisfml.cpp: src/Color.hpp \
		...
		src/gui/guisfml.hpp \
		src/gui/guisfml.hpp
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) src/gui/guisfml.hpp -o moc_guisfml.cpp
...
objects/gui.o: src/gui/gui.cpp src/gui/guisfml.hpp \
		src/Color.hpp \
		src/gui/gui.hpp \
		src/RenderingInterface.hpp \
		src/Raytracer.hpp \
...
objects/guisfml.o: src/gui/guisfml.cpp src/gui/gui.hpp \
		src/RenderingInterface.hpp \
		src/Color.hpp \
		src/Raytracer.hpp \
		src/Scene.hpp \
		...
		src/RaytracerThread.hpp \
		src/gui/guisfml.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o objects/guisfml.o src/gui/guisfml.cpp
...
objects/moc_guisfml.o: moc_guisfml.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o objects/moc_guisfml.o moc_guisfml.cpp
