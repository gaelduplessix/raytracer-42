...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Fri Apr 29 12:44:41 2011
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) objects/raytracer-421.0.0/ && $(COPY_FILE) --parents src/BoundingBox.hpp src/Camera.hpp src/Color.hpp src/DirectLight.hpp src/EquationSolver.hpp src/Light.hpp src/Material.hpp src/Matrix.hpp src/Object.hpp src/ObjectPrimitive.hpp src/Point.hpp src/Ray.hpp src/Raytracer.hpp src/RenderingConfiguration.hpp src/RenderingInterface.hpp src/Rotation.hpp src/Scene.hpp src/Sphere.hpp src/Texture.hpp src/Vector.hpp objects/raytracer-421.0.0/ && $(COPY_FILE) --parents src/BoundingBox.cpp src/Camera.cpp src/Color.cpp src/DirectLight.cpp src/EquationSolver.cpp src/Light.cpp src/main.cpp src/Material.cpp src/Matrix.cpp src/Object.cpp src/ObjectPrimitive.cpp src/Ray.cpp src/Raytracer.cpp src/RenderingConfiguration.cpp src/RenderingInterface.cpp src/Scene.cpp src/Sphere.cpp src/Texture.cpp src/Vector.cpp objects/raytracer-421.0.0/ && (cd `dirname objects/raytracer-421.0.0` && $(TAR) raytracer-421.0.0.tar raytracer-421.0.0 && $(COMPRESS) raytracer-421.0.0.tar) && $(MOVE) `dirname objects/raytracer-421.0.0`/raytracer-421.0.0.tar.gz . && $(DEL_FILE) -r objects/raytracer-421.0.0
