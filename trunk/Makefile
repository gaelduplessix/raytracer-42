...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Fri May 6 19:29:03 2011
...
objects/ParrallelLight.o: src/ParrallelLight.cpp src/Raytracer.hpp \
		src/Scene.hpp \
		src/Camera.hpp \
		src/Point.hpp \
		src/Vector.hpp \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o objects/ParrallelLight.o src/ParrallelLight.cpp
