...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Fri Apr 29 20:11:12 2011
# Project:  raytracer-42.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -unix OBJECTS_DIR=./objects -o Makefile raytracer-42.pro
#############################################################################
...
Makefile: raytracer-42.pro  /usr/lib/qt4/mkspecs/linux-g++/qmake.conf /usr/lib/qt4/mkspecs/common/g++-multilib.conf \
		...
		/usr/lib/qt4/mkspecs/features/lex.prf \
		/usr/lib/qt4/mkspecs/features/include_source_dir.prf
	$(QMAKE) -unix OBJECTS_DIR=./objects -o Makefile raytracer-42.pro
...
objects/main.o: src/main.cpp src/gui/gui.hpp \
		src/Raytracer.hpp \
		src/Scene.hpp \
		src/Camera.hpp \
		src/Point.hpp \
...
objects/Sphere.o: src/Sphere.cpp src/Sphere.hpp \
		src/ObjectPrimitive.hpp \
		src/Vector.hpp \
		src/Point.hpp \
		src/Rotation.hpp \
