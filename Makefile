...
# Generated by qmake (2.01a) (Qt 4.7.3) on: Tue May 10 01:27:10 2011
# Project:  raytracer-42.pro
# Template: app
# Command: /usr/bin/qmake OBJECTS_DIR=./objects LIBS=-lSDL -o Makefile raytracer-42.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt/mkspecs/linux-g++-64 -I. -I/usr/include/QtCore -I/usr/include/QtGui -I/usr/include -I. -Isrc -Isrc/gui -I.
LINK          = g++
...
Makefile: raytracer-42.pro  /usr/share/qt/mkspecs/linux-g++-64/qmake.conf /usr/share/qt/mkspecs/common/g++.conf \
	...
	$(QMAKE) OBJECTS_DIR=./objects LIBS=-lSDL -o Makefile raytracer-42.pro
